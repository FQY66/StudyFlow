...
const routeTitle = computed(() => {
  ...
  const map: Record<string, string> = {
    '/teacher': '首页总览',
    '/teacher/square': '社区论坛',
    '/teacher/square/forum': '留言广场',
    '/teacher/square/chat': '消息窗口',
    '/teacher/projects/management': '项目管理',
    '/teacher/projects/new': '新增项目',
    '/teacher/projects/news': '研学资讯',
    '/teacher/projects/courses': '精品课程',
    '/teacher/projects/courses/create': '新增精品课程',
    '/teacher/common/upload-test': '测试栏',
    '/teacher/sf/ai': 'AI智能问答',
  }
  return map[path] || '首页总览'
})

const showSystemManagement = computed(() => {
  if (route.path.startsWith('/teacher/sf/ai')) return false
  return userRole.value !== '老师'
})
  ...
  <el-container class="layout-root">
    <el-aside :width="isCollapsed ? '64px' : '220px'" class="layout-aside">
      <div class="logo" :class="{ 'logo-collapsed': isCollapsed }">
        ...
        <span v-if="!isCollapsed" class="logo-subtitle">老师工作台</span>
      </div>
      <el-menu class="side-menu" :default-active="activePath" :collapse="isCollapsed" router>
        ...
        <el-sub-menu index="/teacher/square">
          <template #title>
            <el-icon><forumIcon /></el-icon>
            <span>社区论坛</span>
          </template>
          <el-menu-item index="/teacher/square/forum">
            <el-icon><squareIcon /></el-icon>
            <span>留言广场</span>
          </el-menu-item>
          <el-menu-item index="/teacher/square/chat">
            <el-icon><chatIcon /></el-icon>
            <span>消息窗口</span>
          </el-menu-item>
        </el-sub-menu>

        <el-sub-menu index="/teacher/projects">
          <template #title>
            <el-icon><Folder /></el-icon>
            <span>研学项目</span>
          </template>
          <el-menu-item index="/teacher/projects/management">
            <el-icon><Tickets /></el-icon>
            特色项目
          </el-menu-item>
          <el-menu-item index="/teacher/projects/new">
            <el-icon><lanchIcon /></el-icon>
            发布项目
          </el-menu-item>
        </el-sub-menu>

        <el-menu-item index="/teacher/projects/news">
          <el-icon><InfoFilled /></el-icon>
          <span>研学资讯</span>
        </el-menu-item>
        <el-sub-menu index="/teacher/projects/courses">
          <template #title>
            <el-icon><Collection /></el-icon>
            <span>精品课程</span>
          </template>
          <el-menu-item index="/teacher/projects/courses">
            <el-icon>
              <CourseListIcon />
            </el-icon>
            <span>课程列表</span>
          </el-menu-item>
          <el-menu-item index="/teacher/projects/courses/create">
            <el-icon><CourseLanchIcon /></el-icon>
            <span>课程发布</span>
          </el-menu-item>
        </el-sub-menu>
        <el-menu-item index="/teacher/common/upload-test">
          <el-icon><Files /></el-icon>
          <span>测试栏</span>
        </el-menu-item>
        <el-menu-item index="/teacher/sf/ai">
          <el-icon>
            <AiRobotIcon />
          </el-icon>
          <span>Ai智能问答</span>
            ...
            <template #dropdown>
              <div class="avatar-dropdown-shell">
                ...
                <el-dropdown-menu class="avatar-dropdown">
                  <el-dropdown-item class="avatar-menu-item" @click="router.push('/teacher/profile')">
                    <el-icon><User /></el-icon>
                    <span>个人中心</span>
